...
export const USDC: TokenMap = {
  ...
  [ChainId.BKC]: new Token(ChainId.BKC, USDC_ADDRESS[ChainId.BKC], 18, 'KUSDT', 'KUSD Coin'),
  [ChainId.BKC_TESTNET]: new Token(ChainId.BKC_TESTNET, USDC_ADDRESS[ChainId.BKC_TESTNET], 18, 'KUSDT', 'KUSD Coin'),
...
export const WETH9: TokenMap = {
  ...
  [ChainId.BKC]: new Token(ChainId.BKC, WETH9_ADDRESS[ChainId.BKC], 18, 'KKUB', 'Wrapped KUB'),
  [ChainId.BKC_TESTNET]: new Token(ChainId.BKC_TESTNET, WETH9_ADDRESS[ChainId.BKC_TESTNET], 18, 'KKUB', 'Wrapped KUB'),
...
export const WNATIVE: TokenMap = {
  ...
  [ChainId.BKC]: new Token(ChainId.BKC, WNATIVE_ADDRESS[ChainId.BKC], 18, 'KKUB', 'Wrapped KUB'),
  [ChainId.BKC_TESTNET]: new Token(
      ChainId.BKC_TESTNET,
      WNATIVE_ADDRESS[ChainId.BKC_TESTNET],
      18,
      'KKUB',
      'Wrapped KUB'
  ),
